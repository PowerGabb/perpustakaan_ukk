...
@section('content')
    ...
    <div class="bs-toast toast fade show bg-success bottom-0 end-0 position-fixed m-3" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
          ...
          <div class="me-auto fw-semibold">Berhasil Membuat Akun</div>
          <small>sec ago</small>
    ...
    <div class="bs-toast toast fade show bg-danger bottom-0 end-0 position-fixed m-3" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
          <i class="bx bx-bell me-2"></i>
          <div class="me-auto fw-semibold">Berhasil Membuat Akun</div>
          <small>sec ago</small>
